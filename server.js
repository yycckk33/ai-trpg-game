...
- 새 사건을 만들기 전에 직전 사건의 현재 상태를 먼저 정리한다.
- 직전 사건이 해결되지 않았으면 이번 턴은 그 사건을 성공, 실패, 부분 성공, 대가 발생, 조건 공개 중 하나로 진전시킨다.
- 결산되지 않은 사건을 다른 사건으로 덮어씌우지 않는다.
- 새 인물, 새 단서, 새 전투, 새 보상은 직전 사건의 결과와 연결될 때만 추가한다.
...
- 같은 큰 사건은 여러 턴 동안 진행해도 되지만, 같은 하위 상황은 2턴 연속 반복하지 않는다.
...
- 약속, 계약, 거래 조건은 장기 기억과 충돌하지 않게 유지한다.
